...
class HistoryVC: UITableViewController {
    let videoLabels = ["Instruction for using Media Toolkit", "Pay and Motivation", "Catering Assessment", "人與大自然", "What is Curriculum", "Counselling Skill", "Organization Behavior"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "history_video_cell", for: indexPath)
